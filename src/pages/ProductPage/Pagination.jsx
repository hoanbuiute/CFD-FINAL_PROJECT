...
const Pagination = ({ page, limit=0, total=0, onPagiChange }) => {
  ...
  ////Tổng số trang được tính trong useMemo
  ...
  const pageList = useMemo(() => {
    let start = page - PAGE_STEP; ////Star bằng page hiện tại - step
    
    let end = page + PAGE_STEP;////end bằng page hiện tại + step
    ...
    const list = []; ///Đưa số pgae vào mảng băng vòng lặp for
